This repo is a mirror the US government run GSOD (GLOBAL SURFACE
SUMMARY OF DAY) project which hosts historical weather data,
containing data up to the end of 2020.

The data is stored in 7z'd data files which can be extracted with
the script extract.py or manually or with the shell command
...
828-271-4800.  Please email ncdc.orders@noaa.gov if you have
any other questions.
...
d) To move to the correct subdirectory, enter:  
   ...
   Annual files:
   eg, gsod_2006.tar - All 2006 files (compressed) by station, in one tar
file.
